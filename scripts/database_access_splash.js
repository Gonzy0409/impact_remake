...
var gamelog_DB_URL        = "http://7generationgames.com/forgotten_trail/forgotten_trail_db/game_log_db.php";
...
function UpdateGameState(completion_routine) {
    ...
    Perform_Game_Log_DB_Action(
        ...
        completion_routine // No completion routine necessary
    );
}
